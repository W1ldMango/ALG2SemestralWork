...
public class Rezervation {
     ...
     */
        ...
        BufferedImage img= ImageIO.read(new File("lux.jpg"));
    ...
    private static void nonLuxImageRoom() throws IOException {
        BufferedImage img=ImageIO.read(new File("nonlux.jpg"));
        ImageIcon icon=new ImageIcon(img);
        JFrame frame=new JFrame();
        frame.setLayout(new FlowLayout());
        frame.setSize(1024,681);
    ...
    private boolean rezervationCheck() throws IOException {
        roomsnumbers.clear();
        String trash;
        Scanner scanner = new Scanner(new File("roomRezervation.txt"), StandardCharsets.UTF_8);
        try {
            do {
    ...
    public void writeRezervationEmail(String email) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("roomRezervation.txt", true));
        writer.newLine();
        writer.append(email);
        writer.close();
    }
