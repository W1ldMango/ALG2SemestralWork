...
/**
 * A class that is fully responsible for authorization and registration
 */
...
public class Authorization {
    ...
    public void readDB() throws IOException {
        Scanner scanner = new Scanner(new File("2021ALG2SemestralStankovHotel/db.txt"), StandardCharsets.UTF_8);
        try {
            do {
    ...
    public void writeDB(String a) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter("2021ALG2SemestralStankovHotel/db.txt", true));
        writer.newLine();
        writer.append(a);
        writer.close();
    }
